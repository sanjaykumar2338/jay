						...
						<div class="front ">
							...
							<div class="apj-card-one apj-card-one-color" >
								<div class="inner-card-front">
									...
									<i class="fa fa-thumbs-up thumb-font" aria-hidden="true" style="color: #42FF00" ></i>
								</div>
							</div>
						</div>
						...
						<div class="front ">
							...
							<div class="apj-card-two apj-card-two-color" >
								<div class="inner-card-front">
									...
									<i class="fa fa-thumbs-down thumb-font thump-inline" aria-hidden="true" style="color: #FF0000" ></i>
								</div>
							</div>
						</div>
