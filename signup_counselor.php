...
if(isset($_POST['sub'])){
	...
	$councilor_title = mysqli_real_escape_string($con, $_POST["councilor_title"]);
	...
	if(mysqli_num_rows($resdup2) > 0)
	{
		...
		//insert
		$result = mysqli_query($con,"INSERT INTO `tbl_users`(`emailid`,`password`,`usertype`,`token`,`is_email_verified`,`councilor_name`,`councilor_title`,`councilor_business`,`created`,`created_by`)
		VALUES ('$emailid','$cryptedpwd','$usertype','$token','0','$councilor_name','$councilor_title','$councilor_business',NOW(),'0');");
		...
		if($result)
		{
			...
			$mail->Host = "mailer@asurison.com";
			$mail->Port = 465; // or 587
			$mail->Username = "asurison.com";
			$mail->Password = "M40vcg7^";                            // SMTP password
			//$mail->SMTPSecure = 'tls';                            // Enable encryption, 'ssl' also accepted
			$mail->From = 'mailer@asurison.com';
  ...
  <div class="container">
    <div class="after-two">
      <div class="log-inpart-sec">
        ...
        <div class="form-group">
          <input type="text" class="form-control" placeholder="Title" id="councilor_title" name="councilor_title" >
        </div>
		
		<div class="form-group">
          <input type="email" class="form-control" placeholder="Email" id="emailid" name="emailid" autocomplete="off" required>
        </div>
		...
		<div class="form-group">
          <input type="password" class="form-control" placeholder="Password" id="password" name="password" autocomplete="off" required autocomplete="off">
        </div>
