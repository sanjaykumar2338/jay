	...
	<div class="filter-title">
		<div class="row">
			...
			<div class="col-sm-8 col-xs-8">
				<button class=" clear_all" type="button" id="btnclearfilters">Clear Search</button>
			</div>
		</div>
	</div>
...
<ul class="list-group advanced-search-output advance-search-menu">
	...
	<!--housing advance search dropdown-->
<!--<li class="list-group-results housing ">Housing
	...
	<!--housing advance search dropdown end-->
	
	<!--Tution & Fees dropdown-->
...
<!--Tution & Fees dropdown end-->

<!--Specialized Mission dropdown-->
 ...
 <div class="mform_field_wrap">
	...
	<!--Specialized Mission dropdown end-->
	...
	<!--Extended Learning dropdown end-->
 ...
 <div class="mform_field_wrap">
	...
	<!--Religious Affiliation dropdown end-->
	 
	<!--Varsity Athletic Teams dropdown-->
...
<!--Varsity Athletic Teams dropdown end-->
	
	<!--Acceptance Rate dropdown-->
  <!--<li class="list-group-results appladmit">Acceptance Rate
	...
	<div class="mform_field_wrap">
			...
			<select class="form-control" name="applicantsAcceptedMin"  id="applicantsAcceptedMin">        
				...
				<label class="mod_style_outer mb-20" style="line-height: 35px;">
	...
	<!--Acceptance Rate dropdown end-->
	
	<!--Graduation Rate dropdown-->
	<!--<li class="list-group-results graduationrate">Graduation Rate
		<div class="mform_field_wrap">
			<label class="mod_style_outer" style="line-height: 35px;">
	...
	<!--Graduation Rate dropdown end-->

	<!--Financial Aid dropdown -->
	<!--<li class="list-group-results financialaid">Financial Aid
		<div class="mform_field_wrap">
			<label class="mod_style_outer" style="line-height: 35px;">
	...
	<!--Financial Aid dropdown end -->
	
	<!--Special Learning Opportunities dropdown -->
	<!--<li class="list-group-results special-learning " >Special Learning Opportunities
		<div class="mform_field_wrap">

			<label class="mod_style_outer" >
				<input class="mod_style" type="checkbox" name="rotc[]" id="rotc_army" value="SLO51">
				<span class="checkmark" id="chk_rotc_army">ROTC: Army</span> </label>

			<label class="mod_style_outer" >
				<input class="mod_style" type="checkbox" name="rotc[]" id="rotc_navy" value="SLO52">
				<span class="checkmark" id="chk_rotc_navy">ROTC: Navy</span> </label>

			<label class="mod_style_outer" >
				<input class="mod_style" type="checkbox" name="rotc[]" id="rotc_airforce" value="SLO53">
				<span class="checkmark" id="chk_rotc_airforce">ROTC: Air Force</span> </label>

		</div>
	</li>-->
	<!--Special Learning Opportunities dropdown end -->
  </ul>
...
<!--<div class="mylocation cmn-field" id="location-btn" style="display: none">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
			  <h4 class="modal-title">Campus Setting
...
<div id="award-btn" class="advance-filter-modal modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
			  <h4 class="modal-title">Level of Award
...
<!--<div class=" cmn-field l_o_a" id="award-btn" style="display: none">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
			  <h4 class="modal-title">Institution Type
...
<div class=" cmn-field hsg" id="housing-btn" style="display: none">
	<fieldset>
            ...
            <div class="mob-center-btn">
            <button type='submit' class='btn btn-primary next applybtn mybluebtn' name="applybtn7">Apply</button>
        </div>
        </fieldset>
</div>
...
<fieldset class="form-horizontal" role="form">
            ...
            <div class="mob-center-btn">
			<button type='submit' class='btn btn-primary next applybtn mybluebtn' name="applybtn8">Apply</button>
		</div>
        </fieldset>
</div>
-->
				...
				<div class="search-form">
					<form method="POST">
						<div class="input-group">
							<input type="text" name="search_schoolname" value="<?php if(isset($_SESSION['search_schoolname'])){echo $_SESSION['search_schoolname'];} ?>" class="form-control" placeholder="Find a School by Name">
								<div class="input-group-btn">
									<button class="btn btn-default" type="submit" name="btnsearchschoolname">
...
<!--alert box-->
	...
	<div class="myresultalert">
    	...
    	<span class="alert-info-icon"><i class="fa fa-info-circle" aria-hidden="true"></i></span> <span class="alert-msg">Click on the name of the school to add it to your list. After selecting your colleges, click to see your chances of acceptance.</span>
  		</div>
		</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="selectedclg">
       <div class="col-xs-12 col-md-12 mb-30">
		...
		<?php if(isset($_SESSION['clgcb'])){ ?>
        <div align="center" class="list-save-div">
        <button type="button" class="btn btn-primary mybluebtn list_save_btn">Save</button>
        </div>
		<?php } ?>
      </div>
    </div>
