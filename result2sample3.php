...
<style>
    ...
    -webkit-text-stroke-color: #299f00;
	}
		.fa-thumbs-down{
		 -webkit-text-fill-color: white;
    -webkit-text-stroke-width: 2px;
						...
						<div class="front ">
							...
							<div class="apj-card-one apj-card-one-color" >
								<div class="inner-card-front">
									...
									<h2>L<span class="h2-subfont pl-6">ong Shot</span></h2>
									
									
									
									<i class="fa fa-thumbs-up thumb-font" aria-hidden="true" ></i>
								</div>
							</div>
						</div>
						...
						<div class="front ">
							...
							<div class="apj-card-two apj-card-two-color" >
								<div class="inner-card-front">
									...
									<i class="fa fa-thumbs-down thumb-font thump-inline" aria-hidden="true" ></i>
								</div>
							</div>
						</div>
					...
					<div class="flipper">
						<div class="front">
							...
							<div class="apj-card-three apj-card-three-color" >
								...
								<i class="fa fa-thumbs-up fa-rotate-270 thumb-font thump-inline-ro" aria-hidden="true" style=" -webkit-text-fill-color: white;-webkit-text-stroke-width: 2px;-webkit-text-stroke-color: #ed8d00;"></i>
								</div>
							</div>
						</div>
						<div class="back bcolor2">
						...
						<div class="front ">
							...
							<div class="apj-card-four apj-card-four-color" >
								<div class="inner-card-front">
									...
									<i class="fa fa-thumbs-up thumb-font thump-inline" aria-hidden="true" ></i>
