    ...
    <nav class="navbar navbar-expand-lg navbar-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse8">
              ...
              <div class="navbar-nav ml-auto" id="mainnav">
                    <a style="color:#000;" href="login.php" class="nav-item nav-link <?php if ($first_part=="login.php") {echo "active"; } else  {echo "noactive";}?>" >Login Now</a>
              <a  id="logdiv1" href="signup.php" class="nav-item nav-link logdiv <?php if ($first_part=="signup.php") {echo "active"; } else  {echo "noactive";}?>">Sign Up</a>
              </div>
