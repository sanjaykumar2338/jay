...
<div class="container-fluid">
  ...
  <div class="row">   
    ...
    if ($result->num_rows > 0) {
      ...
      $sql = "SELECT * FROM `tbl_users` LEFT join counselor_detail on counselor_detail.user_id = tbl_users.id WHERE tbl_users.usertype = 'College_Counselor' AND `tbl_users`.`is_email_verified` = 1 AND `counselor_detail`.`counselor_privacy` = 'public' ";    
