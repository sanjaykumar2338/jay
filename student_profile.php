<?php
   ...
   */
   ...
   if(isset($_POST['college_builder_by'])){
   // $_SESSION['college_builder_by'] = 'counselor';
    $_SESSION['college_builder_by'] = $_POST['college_builder_by'];
	$_SESSION['college_builder_to'] = $_POST['college_builder_to'];
   }
   ?>
   <!DOCTYPE html>
<html lang="en">
...
<div class="banner inner-banner multi-step-banner" style="background:url(images/create_my_profile_background.png) no-repeat">
  <div class="container">
    ...
    <?php 
    if(isset($_POST['college_builder_by']) || isset($_SESSION['college_builder_by'])){
      echo '<h1> Create Student Profile </h1>';
    }else{
      echo '<h1> Create My Profile </h1>';
    }
    ?>
...
<section>
	<div class="container-fluid">
      ...
      <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 px-0 overflow-hide">
          <div id="progress-bar">
          <div id="1" class="done one progress-bar-item progress-bar-item-edges"><a href="form2.php" class="white-font"><p class="progress-bar-text">Profile</p></a></div>
          <div id="2"class="two progress-bar-item progress-bar-item-edges"><a href="form.php" class="white-font"><p class="progress-bar-text">Filters</p></a></div>
          <div id="3"class=" results progress-bar-item progress-bar-item-edges"><a href="college-search.php" class="white-font"><p class="progress-bar-text">Results</p></a></div>
          <div id="4"class=" chances progress-bar-item progress-bar-item-edges"><a href="#!" class="white-font"><p class="progress-bar-text">Chances</p></a></div>
