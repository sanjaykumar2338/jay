...
<!----------------------------BANNER----------------------------------->
<div class="banner inner-banner positon-center" style="background:linear-gradient( rgb(0 0 0 / 35%) 100%, rgba(0, 0, 0, 0.5)100%), url(images/Counselor.jpg) no-repeat;background-position: center">
  <div class="container">
						...
						<div class="after-two">
						  <div class="log-inpart-sec">
						  	...
						  	<div class="blockbody">
								...
								<div class="full"> 
									<button class="btn logdv" name="sub" id="sub"> Login </button>
						  	    </div>
						  </div>
						</div>
					</div>
